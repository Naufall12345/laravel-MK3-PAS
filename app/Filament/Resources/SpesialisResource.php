...
class SpesialisResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListSpesialis::route('/'),
            'create' => Pages\CreateSpesialis::route('/create'),
            'edit' => Pages\EditSpesialis::route('/{record}/edit'),
        ];
    }
}
